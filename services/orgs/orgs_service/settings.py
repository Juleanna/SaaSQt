...
ROOT_URLCONF = 'orgs_service.urls'
...
WSGI_APPLICATION = 'orgs_service.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': env('DB_NAME', default='orgs_db'),
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_CLASSES': [
        'core.throttle_userip.JWTUserOrIPRateThrottle',
